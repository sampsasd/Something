...
H    1.2238   -2.0304    1.2059""", symmetry=True, basis='6-31+g(d,p)')
#6-31+g(d)
mol_TPB.symmetry_subgroup = 'c2'

rks_TPB = dft.RKS(mol_TPB)
#rks_TPB.grids.level = 6
rks_TPB.xc = 'b86, pw91'
rks_TPB = rks_TPB.newton()
rks_TPB.verbose = 10
rks_TPB.kernel()
#rks_TPB.analyze(verbose=4)

tddft_TPB = tddft.TDDFT(rks_TPB)
tddft_TPB.singlet = True
tddft_TPB.max_cycle = 1000
tddft_TPB.max_space = 100
tddft_TPB.conv_tol = 1e-6
tddft_TPB.verbose = 5
x0 = tddft_TPB.init_guess(rks_TPB)
#noise = 1e-5
#for x in x0:
